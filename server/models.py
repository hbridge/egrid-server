...
class EGridPlant(models.Model):
  ...
  porname = models.CharField('Plant transmission or distribution system owner', max_length=50, blank=True)
  utlsrvnm = models.CharField('Utility name', max_length=128, blank=True)
  numunit = models.PositiveSmallIntegerField('Number of units', null=True)
  ...
  capfac = models.DecimalField('Plant capacity factor (annual production / nameplate)', max_digits=5, decimal_places=4, default=0.0)
